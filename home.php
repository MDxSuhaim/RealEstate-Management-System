...
<body>
    ...
    <body>
        ...
        <script>
            ...
            const API_KEY = "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"; // Paste your API key here
                ...
                fetch(API_URL, requestOptions)
                    ...
                    .then(data => {
                        ...
                        if (userMessage.toLowerCase().includes("who are you")) {
                            ...
                            if (lowercaseUserMessage.includes("customer") || lowercaseUserMessage.includes("i want to buy a property") || lowercaseUserMessage.includes("i want to buy a home")) {
                            ...
                            } else if (lowercaseUserMessage.includes("owner") || lowercaseUserMessage.includes("i want to sell my property") || lowercaseUserMessage.includes("i want to sell my home")) {
                            ...
                            } else if (lowercaseUserMessage.includes("contact information") || lowercaseUserMessage.includes("reach you")) {
